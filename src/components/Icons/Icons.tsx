...
const Close: FC = ({ ...rest }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" {...rest}>
...
const Hamburger: FC = ({ ...rest }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="11" {...rest}>
      <g fill="#2D314D" fill-rule="evenodd">
...
const Logo: FC = ({ ...rest }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="139" height="20" {...rest}>
      <defs>
